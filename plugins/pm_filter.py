...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("🦋 I couldn't find any movie in that name. Pls enter correct movie name and retry once more or else wait for admin to upload the same in the database 🦋")
